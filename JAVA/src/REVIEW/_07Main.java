...
public class _07Main {
	public static void main(String[] args) {
		//객체생성
		_07SharedArea sa = new _07SharedArea();
		sa.account1=new _07Account("010-4547-7874", "김태희", 20000000);
		sa.account2=new _07Account("010-5412-2562", "비", 10000000);
		_07PrintTotalThread t1 =new _07PrintTotalThread(sa); //계좌이체 스레드
		_07TransferThread t2 = new _07TransferThread(sa);// 잔액합계
